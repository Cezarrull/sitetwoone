            ...
            <div className="bodyQuizzes">
                <div className="containerQuizzes">
                    <div className="questionContent">
                        ...
                        <div className={`buttonCheckQuestion ${active.has(0) ? 'buttonOpenResponse' : ''}`} onClick={() => handleClick(0)} id="lalaQuiz">
                            <p>RESPOSTA</p>
                ...
                <div className="containerQuizzes">
                    <div className="questionContent">
                        ...
                        <div className={`buttonCheckQuestion ${active.has(1) ? 'buttonOpenResponse' : ''}`} onClick={() => handleClick(1)} id="lalaQuiz">
                            <p>RESPOSTA</p>
                            <div className="response">
                                <p className="textResponse">
                                    Porque test test test é test por causa do test,
